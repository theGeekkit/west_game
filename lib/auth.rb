module Auth
    ...
    def self.character_intro
      ...
      puts
      sleep 1
      puts "You know your letters?".red.bold.italic
      puts
      sleep 1
      slow_text(0.1) do
        "Sure partner.".green.bold
      end
      ...
      slow_text(0.03) do
        "You are #{$current_character.get_name}, a #{$current_character.get_class} in Bad Medicine!".green
      end
    end
  end
